...
<form class="user" action="${pageContext.request.contextPath}/SvDiagnostico/crear?gatoId=${gatoId}" method="POST">
    ...
    <div class="container-fluid mb-4">
        <div class="card shadow">
            ...
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <button href="${pageContext.request.contextPath}/SvDiagnostico/llamar_altaTratamiento?gatoId=${gatoId}"
                        ...
                        <tbody>
                            <c:forEach var="t" items="${listaTratamientos}">
                                <tr>
                                    ...
                                    <!-- ELIMINAR -->
                                    <form action="${pageContext.request.contextPath}/SvDiagnostico/eliminar_tratamiento" method="POST">
