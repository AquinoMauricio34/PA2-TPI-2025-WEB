...
<form class="user"
      method="POST"
      action="${pageContext.request.contextPath}/SvDiagnostico">
        ...
        <div class="card shadow">
            ...
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <button type="submit"
                        ...
                        formaction="${pageContext.request.contextPath}/SvDiagnostico/llamar_altaTratamiento">
                                ...
                                <tr>
                                    ...
                                    <td style="display:flex; gap:5px">
                                        ...
                                        <button type="submit"
                                                ...
                                                formaction="${pageContext.request.contextPath}/SvDiagnostico/eliminar_tratamiento?tratamientoId=${t.id}&tratamientoDescripcion=${t.getDescripcion().hashCode()}">
                                        ...
                                        <button type="submit"
                                                ...
                                                formaction="${pageContext.request.contextPath}/SvTratamiento/cargar_editar?tratamientoId=${t.id}">
