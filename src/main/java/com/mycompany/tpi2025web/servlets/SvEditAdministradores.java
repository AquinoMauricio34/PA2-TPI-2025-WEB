 ...
 * @author aquin
 */
@WebServlet(name = "SvEditAdministradores", urlPatterns = {"/SvEditAdministradores"})
public class SvEditAdministradores extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SvEditAdministradores</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SvEditAdministradores at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Usuario usu = dao.findAdministrador(nombreUsuario);
        
        HttpSession s = request.getSession();
        s.setAttribute("usuarioEditar", usu);
