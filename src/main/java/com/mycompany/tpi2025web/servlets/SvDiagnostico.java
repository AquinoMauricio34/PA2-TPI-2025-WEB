...
//        GatoJpaController daoG = new GatoJpaController((EntityManagerFactory) request.getServletContext().getAttribute("emf"));
//        TratamientoJpaController daoT = new TratamientoJpaController((EntityManagerFactory) request.getServletContext().getAttribute("emf"));
//        Diagnostico d = daoD.findDiagnostico(Long.valueOf(request.getParameter("diagnosticoId")));
//        HttpSession session = request.getSession();
//        System.out.println("svdiag edit diagnosticaId: "+request.getParameter("diagnosticoId"));
//        System.out.println("DB".repeat(120));
//        System.out.println("SESSION ID = " + session.getId());
//        List<Tratamiento> lista = (List<Tratamiento>) session.getAttribute("tratamientosTemp");
//        List<String> descripcionestTratamientosActuales = d.getTratamientos().stream().map(Tratamiento::getDescripcion).collect(Collectors.toList());
//        System.out.println("svdiag/edit nombres:" +descripcionestTratamientosActuales);
//        System.out.println("svdiag/edit listasession:" +lista);
//        lista = lista.stream()
//            .filter(elemento -> !descripcionestTratamientosActuales.contains(elemento.getDescripcion()))
//            .collect(Collectors.toList());
//        System.out.println("svdiag/edit d tratamientos:" +d.getTratamientos());
//        System.out.println("svdiag/edit listasession modif:" +lista);
//        
//        for (Tratamiento t : lista) {
//            System.out.println("Tratamiento antes null: "+t);
//            if(t.getId()==null) t.setId(null);//aniadido porque si no se genera: Null or zero primary key encountered in UnitOfWork clone
//            System.out.println("Tratamiento despues null: "+t);
//            t.setDiagnostico(d);  // si corresponde
//            try {
//                daoT.create(t);
//                d.addTratamiento(t);
//                System.out.println("Tratamiento guardado: "+t);
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
//        }
//        System.out.println("svdiag/edit diag tratamientos: "+d.getTratamientos());
//        System.out.println("F".repeat(120));
//        System.out.println(request.getParameter("gatoId"));
//        //Gato g = daoG.findGato(Long.parseLong(request.getParameter("gatoId")));
//        //g.getHistorial().addDiagnostico(d);
...
//        try {
//            System.out.println("G".repeat(120));
//            System.out.println("diagnosticoId: "+d.getId());
//            daoD.edit(d);
//            System.out.println("H".repeat(120));
//        } catch (Exception ex) {
//            ex.printStackTrace();
...
//    private void editar(HttpServletRequest request, HttpServletResponse response) throws IOException {
//
//        DiagnosticoJpaController daoD =
//            new DiagnosticoJpaController(
...
//
//        HttpSession session = request.getSession();
//        List<Tratamiento> tratamientosTemp =
//            (List<Tratamiento>) session.getAttribute("tratamientosTemp");
//
//        // se cambian los valores (no la fecha)
//        d.setDiagnostico(request.getParameter("titulo"));
//        d.setDescripcion(request.getParameter("descripcion"));
//
//        //se obtienen las descripciones de los tratamientos existentes
//        Set<String> descripcionesExistentes =
//            d.getTratamientos()
//             .stream()
//             .map(Tratamiento::getDescripcion)
//             .collect(Collectors.toSet());
//        
//        System.out.println(descripcionesExistentes);
//        
//        //solo se aniaden los nuevos tratamientos
//        if (tratamientosTemp != null) {
//            for (Tratamiento tTemp : tratamientosTemp) {
//
//                // si ya existe, no se agrega
//                if (descripcionesExistentes.contains(tTemp.getDescripcion())) {
//                    continue;
//                }
//
//                Tratamiento t = new Tratamiento();
//                t.setDescripcion(tTemp.getDescripcion());
//                t.setFecha_inicio(tTemp.getFecha_inicio());
//                t.setFecha_fin(tTemp.getFecha_fin());
//                t.setAbandono_tratamiento(tTemp.getAbandono_tratamiento());
//
//                t.setDiagnostico(d);
//                d.addTratamiento(t);
//            }
...
//        //guardado
//        try {
//            System.out.println("dId: "+d.getId());
//            daoD.edit(d);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
